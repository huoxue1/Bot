...
func init() {
	...
	go_mybots.ViewNotice = append(go_mybots.ViewNotice,go_mybots.ViewOnNotice{OnNotice: Test,
	...
	go_mybots.ViewMessage = append(go_mybots.ViewMessage,go_mybots.ViewMessageApi{OnMessage: Welcome,
		MessageType: go_mybots.MessageTypeApi.Group,SubType: ""})
	go_mybots.ViewNotice =append(go_mybots.ViewNotice,go_mybots.ViewOnNotice{OnNotice: Leave,
